...
#region Autogenerated code
	...
	public class FontFace : GLib.Object {
		...
		[Obsolete]
		protected FontFace(GLib.GType gtype) : base(gtype) {}
		...
		static GLib.GType _gtype = new GLib.GType (pango_font_face_get_type());
	...
	internal class FontFaceAttribute : GLib.GTypeTypeAttribute {
		[DllImport ("libpango-1.0-0.dll", CallingConvention = CallingConvention.Cdecl)]
		static extern IntPtr pango_font_face_get_type ();

		private static GLib.GType _gtype = new GLib.GType (pango_font_face_get_type ());
