...
#region Autogenerated code
	...
	public struct Rectangle {
		...
		public static Gdk.Rectangle New (IntPtr raw) {
			...
			unsafe { return *(Gdk.Rectangle*)raw; }
		}
		...
		[DllImport("libgdk-win32-2.0-0.dll", CallingConvention = CallingConvention.Cdecl)]
		static extern bool gdk_rectangle_intersect(ref Gdk.Rectangle raw, ref Gdk.Rectangle src2, ref Gdk.Rectangle dest);

		public bool Intersect(Gdk.Rectangle src2, out Gdk.Rectangle dest) {
			dest = new Gdk.Rectangle();
			bool raw_ret = gdk_rectangle_intersect(ref this, ref src2, ref dest);
			bool ret = raw_ret;
			return ret;
		}

		[DllImport("libgdk-win32-2.0-0.dll", CallingConvention = CallingConvention.Cdecl)]
		static extern void gdk_rectangle_union(ref Gdk.Rectangle raw, ref Gdk.Rectangle src2, ref Gdk.Rectangle dest);

		public Gdk.Rectangle Union(Gdk.Rectangle src2) {
			Gdk.Rectangle dest;
			dest = new Gdk.Rectangle();
			gdk_rectangle_union(ref this, ref src2, ref dest);
			return dest;
		}
		...
		[DllImport("glibsharpglue-2", CallingConvention = CallingConvention.Cdecl)]
		static extern void glibsharp_value_set_boxed (ref GLib.Value val, ref Gdk.Rectangle boxed);
...
public static Rectangle Offset (Rectangle rect, Point dr)
{
	...
	internal class RectangleAttribute : GLib.GTypeTypeAttribute {
		...
		private static GLib.GType _gtype = new GLib.GType (gdk_rectangle_get_type ());
