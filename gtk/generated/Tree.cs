...
#region Autogenerated code
	public class Tree {
		...
		public static bool GetRowDragData(Gtk.SelectionData selection_data, out Gtk.TreeModel tree_model, out Gtk.TreePath path) {
		...
		public static bool SetRowDragData(Gtk.SelectionData selection_data, Gtk.TreeModel tree_model, Gtk.TreePath path) {
			Gtk.Application.AssertMainThread();
			bool raw_ret = gtk_tree_set_row_drag_data(selection_data == null ? IntPtr.Zero : selection_data.Handle, tree_model == null ? IntPtr.Zero : tree_model.Handle, path == null ? IntPtr.Zero : path.Handle);
			bool ret = raw_ret;
			return ret;
		}
