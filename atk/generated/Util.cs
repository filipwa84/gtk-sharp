...
#region Autogenerated code
	...
	public class Util : GLib.Object {
		...
		[Obsolete]
		protected Util(GLib.GType gtype) : base(gtype) {}
		...
		static GLib.GType _gtype = new GLib.GType (atk_util_get_type());
...
// Boston, MA 02111-1307, USA.
	...
	internal class UtilAttribute : GLib.GTypeTypeAttribute {
		[DllImport ("libatk-1.0-0.dll", CallingConvention = CallingConvention.Cdecl)]
		static extern IntPtr atk_util_get_type ();

		private static GLib.GType _gtype = new GLib.GType (atk_util_get_type ());
